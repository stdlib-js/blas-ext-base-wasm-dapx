...
var O=require('@stdlib/assert-is-wasm-memory/dist'),q=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),S=require('@stdlib/utils-inherit/dist'),f=require('@stdlib/wasm-module-wrapper/dist'),T=require('@stdlib/error-tools-fmtprodmsg/dist'),B=y();function n(e){if(!(this instanceof n))return new n(e);if(!O(e))throw new TypeError(T('nullH0',e));return f.call(this,B,e,{env:{memory:e}}),this}S(n,f);q(n.prototype,"main",function(r,s,i,t){return this._instance.exports.stdlib_strided_dapx(r,s,i,t),i});q(n.prototype,"ndarray",function(r,s,i,t,o){return this._instance.exports.stdlib_strided_dapx_ndarray(r,s,i,t,o),i});h.exports=n
