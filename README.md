...
```javascript
import { Module } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-wasm-dapx@deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-wasm-dapx/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/blas-ext-base-wasm-dapx/actions/workflows/test.yml?query=branch:main
